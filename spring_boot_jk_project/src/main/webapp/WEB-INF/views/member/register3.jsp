...
<%-- 	${request.getParameter("id") }
 --%>	
	...
	패스워드: <input type="password" name="pw" value="<%=request.getParameter("pw") %>" readonly><br>
	이름: <input type="text" name="name" value="<%=request.getParameter("name") %>" readonly><br>
	이메일: <input type="text" name="email" value="<%=request.getParameter("email") %>" readonly><br>
	나이: <input type="text" name="age" value="<%=request.getParameter("age") %>" readonly><br>
	<input type="submit" value="전송">
	<input type="reset" value="리셋">
</form>
</body>
